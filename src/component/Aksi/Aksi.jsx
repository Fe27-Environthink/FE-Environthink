    ...
    <>
      ...
      <div className="container">
        <div className="artikel" id="artikel">
          ...
          <p className="sub-title">Ayo Bergabung dan Beraksi untuk Masa Depan Bumi yang Lebih Baik!</p>
          ...
          {item.map(item=>(
              ...
              <div className="card" key={item} style={{ width: "18rem" }}>
