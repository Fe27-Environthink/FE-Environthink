        ...
        >
            <div className="card-body">
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col-md-2" className='artikelimage'>Image</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <Link
                                    to=""
                                    className="btn bg-success btn-update text-sm me-4 text-white px-4 py-2"
                                >
                                Update
                                </Link>
                                <button
                                    to="/"
                                    className="btn bg-danger btn-delete text-sm me-4 text-white px-4 py-2"
                                    >
                                    Delete
                                </button>
                            </td>
