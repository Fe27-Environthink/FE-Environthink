                    ...
                    {isLoading?(
                        ...
                        <div key={item.id} className="col-md-6 col-lg-4 mb-3 pb-4">
                            <div className="card card-infografis h-100">
                                <img src={item.images} style={{cursor: "pointer"}} className="card-img-top" data-bs-toggle="modal" data-bs-target="#${data[i].id}Backdrop" alt="infografis"/>
                                <div className="card-body">
                                    <h1 className="card-title fs-6 title-infografis" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                        {item.titleInfografis}
                                    </h1>
                                    <div className="modal fade" id="${item.id}Backdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div className="modal-dialog">
                                        <div className="modal-content">
                                            <div className="modal-header">
                                                <h1 className="modal-title fs-5" id="staticBackdropLabel">{item.titleInfografis}</h1>
                                                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div className="modal-body">
                                                <img src={item.images} className="card-img-top" alt="infografis"/>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
